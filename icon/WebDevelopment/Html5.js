...
const Html5 = ({ color = 'currentColor', size = '1em', ...rest }) => {
    return (
        <svg
            ...
            {...rest}
            viewBox="0 0 32 32" >
            <polygon points="5.902 27.201 3.655 2 28.345 2 26.095 27.197 15.985 30 5.902 27.201" fill="#e44f26" /><polygon points="16 27.858 24.17 25.593 26.092 4.061 16 4.061 16 27.858" fill="#f1662a" />
