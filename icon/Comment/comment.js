...
const Comment = ({ color = 'currentColor', size = '1em', ...rest }) => {
    return (
        ...
        <svg width={size} height={size} fill={color} xmlns="http://www.w3.org/2000/svg" {...rest} viewBox="0 0 24 24" version="1.1">

            <g stroke="none" strokeWidth="1"  fillRule="evenodd">
                <g id="ic_fluent_comment_24_regular"  fillRule="nonzero">
