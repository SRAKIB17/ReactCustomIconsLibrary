...
const TwitterColor = ({ color = 'currentColor', size = '1em', ...rest }) => {
    return (
        <svg
            ...
            height={size}
            fill={color}
            {...rest} viewBox="0 0 231.104 231.104" >
            <g>
                <path fill="#3FA9F5" d="M4.453,173.33c9.763-1.192,19.663,0.092,29.426-1.512c4.904-0.779,9.396-2.429,13.842-4.171
