...
const YoutubeRedText = ({ color = 'currentColor', size = '1em', ...rest }) => {
    return (
        <svg
            ...
            height={size}
            fill={color}
            {...rest} viewBox="0 0 512 512" >
            <path fill="#E21B1B" d="M493.392,347.76H224.728c-10.256-0.032-18.568-8.344-18.6-18.6V182.84
            ...
            <g>
                <path fill="#FFFFFF" d="M262.224,235.568H240.52V223.96h57.6v11.608h-21.96v64.592h-13.936V235.568z"/>
                <path fill="#FFFFFF" d="M350.12,283.624c0,6.552,0.232,12,0.448,16.52h-12.224l-0.68-8.392h-0.2
                ...
                <path fill="#FFFFFF" d="M364.704,300.152c0.232-3.752,0.48-9.824,0.48-15.496v-64.8h13.888v32.8h0.232
                ...
                <path fill="#FFFFFF" d="M441.168,276.528c0.304,8.256,7.248,14.704,15.504,14.4c0.488-0.016,0.976-0.056,1.456-0.128
            ...
            <g>
                <g>
                    <path opacity='0.2' fill='#FFFFFF' enable-enableBackground='new' d="M206.128,187.792V313.2
