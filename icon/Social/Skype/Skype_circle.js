...
const SkypeCircle = ({ color = 'currentColor', size = '1em', ...rest }) => {
    return (
        <svg style={{ borderRadius: '50%' }}
            ...
            height={size}
            fill={color}
            {...rest} viewBox="0 0 291.364 291.364" >
            <g>
                <path fill="#00AFF0" d="M282.966,176.612c2.094-9.495,3.204-19.309,3.204-29.405c0-75.661-62.197-137.011-138.941-137.011
                ...
                <path fill="#FFFFFF" d="M210.6,203.131c-5.362,7.62-13.21,13.61-23.542,17.916c-10.333,4.342-22.568,6.491-36.724,6.491
